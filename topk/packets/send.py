...
sys.path.append("/home/mnc/p4-dev/topk/packets/")
...
def main():
    ...
    if a.dist == 'z':
        if a.fat_tree == 1: #TODO
            f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s_%s' %(p, str(a.entry),a.num*10, a.host_num), 'r')
            # f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s' %(p, str(a.entry),a.num*12*10), 'r')
            for i in range(a.num*12*10):  
                lines.append(f.readline())
        else:
            if a.sort == 1 or a.sort== 3 :
                f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s_sorted' %(p, str(a.entry), str(a.num*10)), 'r')
            else: # sort == 2
                f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s' %(p, str(a.entry), str(a.num*10)), 'r')
        ...
        if a.fat_tree == 1:
            f = open('/home/mnc/p4-dev/topk/packets/dataset/z_dist_%s_%s_%s' %(str(a.entry),a.num*10, a.host_num), 'r')
            # f = open('/home/mnc/p4-dev/topk/packets/dataset/u_dist_%s_120000' %(str(a.entry)), 'r')
            for i in range(120000):  
                lines.append(f.readline())

        else:
            f = open('/home/mnc/p4-dev/topk/packets/dataset/u_dist_%s_%s' %(str(a.entry), str(a.num*10)), 'r')   
            for i in range(a.num):  
                lines.append(f.readline())
    ...
    #             n = line.split()
        ...
        with open('/home/mnc/p4-dev/topk/packets/dataset/g_dist', 'r') as f:
    ...
    # elif a.dist == 'u':
    #     with open('/home/mnc/p4-dev/topk/packets/dataset/u_dist', 'r') as f:
