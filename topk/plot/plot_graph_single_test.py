...
for entry in [1000,3000,5000]: # FIXME : modify just this line
    ...
    for i in range (1,2):
        ...
        dist = 'z'
        f = open('/home/mnc/p4-dev/topk/logs/mininet/daiet/daiet-single-1000--{}-1.1-3.csv'.format(entry), 'r')
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        result_daiet[str(entry)].append(1-int(a)/(num))
        f.close()

        f = open('/home/mnc/p4-dev/topk/logs/mininet/daiet/daiet-single-1000--{}-2-3.csv'.format(entry), 'r')
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        ...
        f = open('/home/mnc/p4-dev/topk/logs/mininet/daiet-single-1000-u-{}-{}.csv'.format(entry,i), 'r') 
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        print(a)
    ...
    for i in range (1,2):
        ...
        dist = 'z'
        f = open('/home/mnc/p4-dev/topk/logs/mininet/topk/topk-single-1000--{}-1.1-3.csv'.format(entry), 'r')
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        result_topk[str(entry)].append(1-int(a)/(num))
        f.close()

        f = open('/home/mnc/p4-dev/topk/logs/mininet/topk/topk-single-1000--{}-2-3.csv'.format(entry), 'r')
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        ...
        dist = 'u'
        # f = open('/home/mnc/p4-dev/topk/logs/mininet/{}-single-{}-{}-{}-{}.csv'.format(t,num,'',entry,i), 'r')
        f = open('/home/mnc/p4-dev/topk/logs/mininet/topk-single-1000-u-{}-{}.csv'.format(entry,i), 'r') 
        opened_file = f.readlines()
        a = opened_file[-1].split(',')[1]
        print(a)
